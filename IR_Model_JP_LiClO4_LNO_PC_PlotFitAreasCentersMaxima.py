# -*- coding: utf-8 -*-
"""
Created on Fri Apr 30 09:52:28 2021

@author: jpalmer
"""

"""
'plot_results' plots the areas and centers of the desired components from the 
fit versus spectrum number. The only input the function takes is a list of the
desired peaks from 'x_peaks' defined at the beginning of the script. For example,
plot_results([543, 545, 573, 624]) would be a valid call.
...
# call the function
plot_fit_results([514,545,568,590], 'C:/Users/jpalmer/Documents/SCP/Data/FTIR/temp/FittingOutput_2021_05_07_11_07_33')

# 514,543,545,568,590,623
