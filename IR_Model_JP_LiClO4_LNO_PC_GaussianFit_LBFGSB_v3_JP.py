# -*- coding: utf-8 -*-
"""
Created on Mon May  3 10:37:19 2021
...
def initial_fit():
    ...
    initial_vals = {'folder':'C:/Users/jpalmer/Documents/SCP/Data/FTIR/LNO_1MLiClO4inPC_Data_BLSub/LNO_1MLiClO4inPC_Data_BLSub',
                    'start' : 37, # Which run do you want to fit? 1 is the first
...
def fit_all(insitu_data, best_vals, curves, amplitudes, areas):
    ...
    from lmfit.models import GaussianModel
    # Define your intial parameters here.  
    initial_vals = {'start' : 37, # Which run do you want to start the fit? 1 is the first. this parameter matters when fitting a select number of spectra
                    'step' : 1, # At what interval should spectra be selected? 1 is recommended because of peak shifting
                    'amount' : 353, # How many total spectra do you want to fit? 
