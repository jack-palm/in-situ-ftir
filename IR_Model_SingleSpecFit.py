# -*- coding: utf-8 -*-
"""
Created on Mon May  3 12:04:37 2021
...
def single_fit():
    ...
    initial_vals = {'filepath':'C:/Users/jpalmer/Documents/SCP/Data/FTIR/FTIR_electrolyteControls/Gen2EL.0.BLsub.txt',
                    'Plot_Title' : 'Gen2 Electrolyte',
                    'lower_bound' : 462, # Lowest wavenumber of fitting domain
                    'upper_bound' : 630, # Highest wavenumber of fitting domain
                    'electrode_peaks' : [514,545,568,590], # Wavenumbers of components
                    'electrolyte_peaks' : [543,623], # Wavenumbers of components
                    'tolerance' : 10.0, # Amount allowed to deviate from peaks defined above 
                    'first_vals' : pd.DataFrame(np.array([[1,514,17], 
                                                        [1.3,543,14], 
                                                        [1,545,10],
                                                        [0.5,568,7],
                                                        [0.3,590,4],
